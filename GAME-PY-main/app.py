...
IMAGEM_CANO = pygame.transform.scale2x(
    pygame.image.load(os.path.join('imgs', 'cano1.png'))
)
...
IMAGEM_BACKGROUND = pygame.transform.scale2x(
    pygame.image.load(os.path.join('imgs', 'fundo.png'))
)

IMAGENS_PASSARO = [
    pygame.transform.scale2x(
        pygame.image.load(os.path.join('imgs', 'Hitman-removebg-preview.png'))
    ),
    pygame.transform.scale2x(
        pygame.image.load(os.path.join('imgs', 'Hitman2-removebg-preview.png'))
    ),
    pygame.transform.scale2x(
        pygame.image.load(os.path.join('imgs', 'Hitman3-removebg-preview.png'))
    )
]
